...
function LoginForm() {
  ...
  return (
    <div className="w-full max-w-lg space-y-4">
      <aside className="rounded-xl border border-red-200 bg-red-50/80 px-4 py-3.5 text-[16px] leading-relaxed text-red-700">
        <p>
      ...
      >
        <div>
          <h1 className="text-lg font-semibold leading-snug">
            LH/SH/GH 매입약정 부동산랩 현황관리
          </h1>
          <p className="mt-1 text-xs text-muted">iM증권 임직원 전용 정보시스템</p>
        </div>
